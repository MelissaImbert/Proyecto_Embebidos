...
void GPS_getPosition( GPSPosition_t *p_pos, uint8_t *p_sentence ){
    ...
    offset=12+GPS_RMC_RUN_LEN+GPS_RMC_COMMA_LEN+GPS_RMC_FIX_LEN+GPS_RMC_COMMA_LEN+GPS_RMC_UTC_LEN+GPS_RMC_COMMA_LEN;
...
void GPS_getUTC( struct tm *p_newtime, uint8_t *p_sentence ){
    ...
    offset=12+GPS_RMC_RUN_LEN+GPS_RMC_COMMA_LEN+GPS_RMC_FIX_LEN+GPS_RMC_COMMA_LEN;
    // Copy Year YYYY
    memset( temp_str, 0, 5 );
